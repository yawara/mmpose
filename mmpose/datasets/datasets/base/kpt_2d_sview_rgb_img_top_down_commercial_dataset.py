...
LID_TO_NAME = {l["id"]: l["name"] for l in LICENSES}


def is_commercial(img):
    name = LID_TO_NAME[img["license"]]
...
class Kpt2dSviewRgbImgTopDownCommercialDataset(Dataset, metaclass=ABCMeta):
